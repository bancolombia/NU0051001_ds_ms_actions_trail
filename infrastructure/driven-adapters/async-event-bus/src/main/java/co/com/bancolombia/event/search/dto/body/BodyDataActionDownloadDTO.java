...
@EqualsAndHashCode
public class BodyDataActionDownloadDTO implements Serializable{
    @NonNull
    private final MetaDTO meta;
    @NonNull private final BodyDataActionDownloadDTO.Request request;
    @NonNull private final BodyDataActionDownloadDTO.Response response;
